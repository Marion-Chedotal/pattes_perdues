...
const Legals = () => {
  return (<div> <h5>1 - Édition du site</h5>
  <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est précisé aux utilisateurs du site internet https://www.pattes-perdues.fr l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi:</p>
  ...
  <p>Hébergeur : PlanetHoster - 4416 Louis B. Mayer, Laval (Québec) H7P 0G1, Canada </p>
  <p>Téléphone : +33 1 76 60 41 43</p>
  <p>Délégué à la protection des données : Mache - marion.chedotal@my-digital-school.org</p>
  ...
  <p>Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à marion.chedotal@my-digital-school.org.</p>
</div>)
};
